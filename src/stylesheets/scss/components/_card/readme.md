...
<div class="card card-fw">
    <!-- Card wrapper -->
        ...
        <!-- Card Head -->
            <div class="card-head">
                <img class="card-head-avatar avatar" alt="avatar" src="./src/images/checker_bg.png">
        ...
        <!-- Card Media -->
            <div class="card-media-container">
                <img class="card-media" alt="card-media" src="./src/images/img_fw.png">
...
<div class="card card-l">
    <div class="card-container">
        ...
        <div class="card-media-container">
            <img class="card-media" alt="card-media" src="./src/images/img_l.png">
            <div class="card-media-overlay">
                <div class="card-media-overlay-top">
                    <span class="tag"> Bestseller </span>
                    <i class="card-media-overlay-videoBtn
...
<div class="card card-m-wide">
    <div class="card-container">
        <div class="card-media-container">
            <img class="card-media" alt="card-media" src="./src/images/img_m_wide.png">
        </div>
        <div class="card-body">
...
<div class="card card-m">
    <div class="card-container">
        <div class="card-media-container">
            <img class="card-media" alt="card-media" src="./src/images/img_m.png">
        </div>
        <div class="card-body">
